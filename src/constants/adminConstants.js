...
export const bestItemNo = 5; // saleCount가 가장 많은 것부터 10개를 뽑도록
sessionStorage.setItem('newItemDays', 20)
sessionStorage.setItem('bestItemNo', 5)
...
export const getBestItemNo = () => {
    return sessionStorage.getItem('bestItemNo') ? parseInt(sessionStorage.getItem('bestItemNo'), 5) : 10;
};